    ...
    >
      <View style={styles.identityRow}>
        <View style={styles.mark}>
          <MarkIcon color={Colors.primary} size={Spacing.four} />
        </View>
      ...
      <View style={styles.details}>
        ...
        {location && (
          <View style={styles.detailRow}>
            <MapPin color={Colors.textSecondary} size={Spacing.three} />
            <Text numberOfLines={1} style={styles.detailText}>{location}</Text>
          </View>
        )}
        {listing.ratingAverage !== undefined && (
          <View style={styles.detailRow}>
            <Star color={Colors.warning} fill={Colors.warning} size={Spacing.three} />
        ...
        {availability && (
          <View style={styles.detailRow}>
            <CalendarClock color={Colors.primary} size={Spacing.three} />
      ...
      <View style={styles.badges}>
        {isSponsored && <Badge label="Sponsored" variant="neutral" />}
        {listing.badge && <Badge label={listing.badge} variant="info" />}
      </View>
    </Pressable>
  );
}
